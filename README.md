...
6. Open `Student\_Budget\_Analysis.xlsx` to view the static Excel dashboard
7. Open `Student\_Budget\_Analysis.pbix` in **Power BI Desktop** to explore the interactive dashboard
...
[LinkedIn](https://www.linkedin.com/in/oluwaferanmi-otudeko) | [GitHub](https://github.com/Feranmi2003)
